    ...
    var t = {
        ...
        extend: function (e, n) {
            t.iterate(n, function (i) {
                t.isArray(n[i]) ? (t.isArray(e[i]) || (e[i] = []), t.extend(e[i], n[i])) : "object" == typeof n[i] ? ("object" != typeof e[i] && (e[i] = {}),
                    t.extend(e[i], n[i])) : e[i] = n[i]
            })
        },
        newStyle: function (t) {
        ...
        breakpoints: function (e) {
            ...
            return n.prototype.matches = function () {
                ...
                t.iterate(e, function (i) { t.obj.breakpoints[i] = new n(i, e[i]) }),
        ...
        initEvents: function () {
            t.on("resize", function () {
                ...
                window.onorientationchange && t.on("orientationChange",
            ...
            document.addEventListener ? !function (e, n) {
                ...
                window.matchMedia ? t.matchesMedia = function (t) {
                    ...
                    var e, n, i, a, r = {
                        ...
                        o = !1;
                    for (i = t.split(/\s+and\s+/),
                        e = 0;
                        e < i.length;
                        e++)n = i[e],
                            "(" == n.charAt(0) && (n = n.substring(1, n.length - 1),
                                a = n.split(/:\s+/),
                                2 == a.length && (r[a[0].replace(/^\s+|\s+$/g, "")] = parseInt(a[1]), o = !0)
                            );
                    if (!o)
                        return !1;
        ...
        initVars: function () {
            ...
            e = "other",
                ...
                t.iterate(i, function (t, i) {
                    return a.match(i[1]) ? (e = i[0],
                        n = parseFloat(i[2] ? i[2](RegExp.$1) : RegExp.$1), !1) : void 0
                }),
                t.vars.os = e,
                t.vars.osVersion = n,
